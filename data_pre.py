...
class DataPre:
    ...
    def raw_pre(self):
        ...
        # raw_branch
        branch_cols = ['f, from bus number', 't, to bus number', 'x, reactance (p.u.)', 'r, resistance (p.u.)', 'b, total line charging susceptance (p.u.)', 'rateA, MVA rating A (long term rating)',
